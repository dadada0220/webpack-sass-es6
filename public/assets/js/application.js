...
/***/ "./_src/js/function/adjustViewport.js":
/*!********************************************!*\
  !*** ./_src/js/function/adjustViewport.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
 ...
 */
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (_executeWindowWidth) {
...
/***/ "./_src/js/module/DrawerMenuToggle.js":
/*!********************************************!*\
  !*** ./_src/js/module/DrawerMenuToggle.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DrawerMenuToggle)
/* harmony export */ });
 ...
 */
var DrawerMenuToggle = /*#__PURE__*/function () {
  function DrawerMenuToggle(_parm) {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, DrawerMenuToggle);
    this.modalId = _parm.modalId;
    this.modal = document.querySelector("#".concat(this.modalId)) || false;
    if (!this.modal) return;
    this.toggleBtn = document.querySelector(_parm.toggleBtn) || false;
    this.closeButtons = _parm.closeButtons ? (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelectorAll(_parm.closeButtons)) : false;
   ...
   * モーダルを開く
   */
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(DrawerMenuToggle, [{
    key: "open",
    value: function open() {
      var _this = this;
      MicroModal.show(this.modalId, {
        onShow: function onShow(_modal) {
          _modal.ariaHidden = false;
          _this.toggleBtn.ariaExpanded = true;
          delete _this.toggleBtn.dataset.micromodalTrigger;
          _this.toggleBtn.dataset.micromodalClose = _this.modalId;
        },
        onClose: function onClose(modal) {
          modal.ariaHidden = true;
          _this.toggleBtn.ariaExpanded = false;
          delete _this.toggleBtn.dataset.micromodalClose;
          _this.toggleBtn.dataset.micromodalTrigger = _this.modalId;
        },
        disableScroll: true,
    ...
    value: function addEvent() {
      var _this2 = this;
      if (this.container) {
        this.container.addEventListener('click', function (_ev) {
          _ev.stopImmediatePropagation();
        });
      }
      if (this.toggleBtn) {
        this.toggleBtn.addEventListener('click', function (_ev) {
          _this2.toggle();
        });
      }
      if (this.closeButtons.length) {
        this.closeButtons.forEach(function (_closeButton) {
          _closeButton.addEventListener('click', function (_ev) {
            _ev.preventDefault();
            MicroModal.close(_this2.modalId);
          });
        });
      }
    }
...
var SmoothScroll = /*#__PURE__*/function () {
  function SmoothScroll(_parm) {
    ...
    this.elmLinks = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelectorAll(_parm.targets));
...
/***/ "./_src/js/module/SplideSlider.js":
/*!****************************************!*\
  !*** ./_src/js/module/SplideSlider.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SplideSlider)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
var SplideSlider = /*#__PURE__*/function () {
  function SplideSlider(_parm) {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, SplideSlider);
   ...
   * ギャラリータイプのスライダー初期化
   */
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(SplideSlider, [{
    key: "galleryInit",
    value: function galleryInit() {
      var splide = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_3__["default"](this.parentSelector, {
        type: 'slide',
        arrows: true,
        pagination: true,
        perPage: 1,
      ...
      var thumbnails = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelectorAll(this.thumbsSelector));
      var current;
...
/* harmony import */ var _function_adjustViewport__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./function/adjustViewport */ "./_src/js/function/adjustViewport.js");
...
/* harmony import */ var _module_DrawerMenuToggle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./module/DrawerMenuToggle */ "./_src/js/module/DrawerMenuToggle.js");
/* harmony import */ var _module_SplideSlider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./module/SplideSlider */ "./_src/js/module/SplideSlider.js");
// Library
...
var init = function init() {
  ...
  (function () {
    var drawerMenuToggle = new _module_DrawerMenuToggle__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  (function () {
    var splideSlider = new _module_SplideSlider__WEBPACK_IMPORTED_MODULE_4__["default"]();
    splideSlider.init();
  })();
};
window.addEventListener('DOMContentLoaded', function () {
  (0,_function_adjustViewport__WEBPACK_IMPORTED_MODULE_1__["default"])();
  init();
});
})();
